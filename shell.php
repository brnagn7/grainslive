<?php include('inc/header.html'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Local Security
                    <small>Linux</small>
                </h1>
            </div>
        </div>
        ...
        <div class="panel panel-warning">
          ...
          <h3 class="panel-title">Local System Security <img src="webroot/img/tux4.png" class="img-rounded"></h3>
          <a href="/grainslive">Back</a>
          </div>
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Security</a></li>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <h3>Local Security On Linux</h3>
      <p>Any operating system connected to the network is insecure, Linux is no exception, so our task will always be to minimise the opportunity for compromise whether that be by privielge escalation, root kits, or a plenitude of backdoors. So where do we start? Well there are no hard and fast rules that work in every situation. So the key is to be prepared, well informed, professional and above all patient. In this section we look at a few interesting concepts regarding security all from the prospective of an Administrator.</p>
    </div>
