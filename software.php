<?php include('inc/header.html'); ?>
    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
          ...
          <h3 class="panel-title">Local System Security <img src="webroot/img/tux5.png" class="img-rounded"></h3>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <p>Software management is one of the greatest advancements under Linux for enterprise IT environments. Automation is made that much easier and System Administrators are able to use package management systems to make their installation processes scalable to thousands of systems and alieviating the need for manual operations on individual systems. </p>
    </div>
